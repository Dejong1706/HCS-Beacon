...
function ManagementSettings() {
  ...
  const addInfo = () => {
    //입력받은 데이터들을 JSON형식으로 서버에 보내는 함수
    ...
    if (
      serverinfo.adminLoginId !== "" &&
      serverinfo.doorId !== "" &&
      serverinfo.doorName !== "" && //빈 칸 입력을 막는 코드
      serverinfo.openTime !== "" &&
      serverinfo.closeTime !== "" &&
  ...
  const clearData = () => {
    //Modal창을 나갔을 때 데이터들을 초기화 시켜주는 함수
    setIsMonitoring("");
    setIsSelected(false);
    setCheckedList([]);
  ...
  modal = (
    ...
    >
      ...
      <ModalContent style={{ height: "80%" }}>
        ...
        >
          <FormControl
            style={{ width: "85%", margin: "auto", marginBottom: "2%" }}
          >
          ...
          <FormControl
            mt={4}
            style={{ width: "85%", margin: "auto", marginBottom: "3%" }}
          >
            <div style={{ display: "flex" }}>
          ...
          <FormControl mt={4} style={{ width: "85%", margin: "auto" }}>
            ...
            >
              ...
              >
                ...
                <li style={{ border: "solid 3px gray" }}>
                  <DatePicker
              ...
              >
                ...
                <li style={{ marginRight: "1%" }}>
                  <Checkbox
                    value={"월요일"}
                    onChange={(e) => {
                      handleCheckdList(e.target.checked, e.target.value);
                    }}
                  >
                    월요일
                  </Checkbox>
          ...
          <div className="Main">
            <div className="MainHeader">
              ...
              <div className="BtnDiv" style={{ display: "flex" }}>
                <Button
                  onClick={force}
                  style={{ marginRight: "10%", backgroundColor: "#ffb300" }}
                >
