...
function useReservationCheck() {
  ...
  const StartDaySearch = (date) => {
    ...
    const startDayresult = DataClone.filter(
      (e) =>
              ...
              <table>
                <tbody>
                  ...
                  {Data.map((item, index) => {
                    ...
                    const DataDate =
                      new Date(enterDay).getFullYear() +
                      "-" +
                      String(new Date(enterDay).getMonth() + 1).padStart(
                        2,
                        "0"
                      ) +
                      "-" +
                    ...
                    const EnterTime =
                      String(new Date(enterDay).getHours() - 9).padStart(
                        2,
                        "0"
                      ) +
                      ":" +
                      String(new Date(enterDay).getMinutes()).padStart(2, "0") +
                      ":" +
                      String(new Date(enterDay).getSeconds()).padStart(2, "0");
                    const ExitTime =
                      String(new Date(exitDay).getHours() - 9).padStart(
                        2,
                        "0"
                      ) +
                      ":" +
                      String(new Date(exitDay).getMinutes()).padStart(2, "0") +
                      ":" +
                      String(new Date(exitDay).getSeconds()).padStart(2, "0");
                    return (
                      <tr key={index}>
